...
public class Main {
    ...
    public static void main(String... a) {
        ...
        try {
			Bio bioLocal = (Bio) Class.forName("com.resto.comparator.memory.Bio").newInstance();
			Bio bioLocalA = (Bio) Class.forName("com.resto.comparator.memory.Bio").newInstance();
			Bio bioLocalB = (Bio) Class.forName("com.resto.comparator.memory.Bio").newInstance();
			Bio bioLocalC = (Bio) Class.forName("com.resto.comparator.memory.Bio").newInstance();
			Bio bioLocalD = (Bio) Class.forName("com.resto.comparator.memory.Bio").newInstance();
			Bio bioLocalE = (Bio) Class.forName("com.resto.comparator.memory.Bio").newInstance();
